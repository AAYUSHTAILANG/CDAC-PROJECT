...
public class UsersController {
	...
	public List<Users> getOwnerRequest(@PathVariable int roleId) {
       ...
       List<Users> u = users_service.getOwnerRequest(role);
    //   Owner o = os.getOwner(u);
       
        return users_service.getOwnerRequest(role);
	}
	
	//if admin approves it 
		@PutMapping("/updateOwnerRequest/{user_id}")
		public Users updateRequest(@RequestBody Users occa,@PathVariable int user_id)
		{
			return users_service.updateRequest(occa,user_id);
		}
		
		
		//if admin rejects it
		@PutMapping("/rejectOwnerRequest/{user_id}")
		public Users rejectRequest(@RequestBody Users occa,@PathVariable int user_id)
		{
			return users_service.rejectRequest(occa,user_id);
		}
