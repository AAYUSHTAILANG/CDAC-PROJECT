...
public class Users {
	...
	@Column
	private boolean user_active_status;
	...
	public void setUser_active_status(boolean user_active_status) {
	...
	public Users(String user_email, String user_password, boolean user_active_status, Roles user_role) {
		super();
		this.user_email = user_email;
		this.user_password = user_password;
		this.user_active_status = user_active_status;
